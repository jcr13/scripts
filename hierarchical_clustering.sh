...
rm -r Cpptraj_linkage_sieve_eps_$r
...
cluster hieragglo epsilon $r linkage rms ${res}@CA,CB sieve 10 summary summary singlerepout representative repout unique repfmt pdb clusterout clusttraj avgout avg avgfmt pdb
go
EFO

...
cd $PBS_O_WORKDIR
source /mnt/b/projects/sciteam/gkg/Source/VirtualEnvs/BigTime/bin/activate
export OPENMM_DIR=/mnt/b/projects/sciteam/gkg/Source/OpenMM/BinBigTime
...
export OPENMM_CUDA_COMPILER=/opt/nvidia/cudatoolkit6.5/6.5.14-1.0502.9613.6.1/bin/nvcc

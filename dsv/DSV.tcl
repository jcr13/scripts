	################################################################################
	#This file contains the DSV program developed in the lab of Riccardo Baron Lab #
...
overproc VisFT {FTstart FTend FTfileformat} {
	...
	# Example: VisFTMap 1 5 ftmap-%d.pdb 2V1D.pdb                                                           #
	# Where ftmap-1.pdb, ftmap-2.pdb, ftamp-3.pdb, ftamp-4.pdb, and ftmap-5.pdb will be aligned to 2V1D.pdb #
#################################################################################################################
...
overproc VisST { STstart STend STfileformat } {
    ...
    # Example: VisSiteMap 1 5 sitemap-%d.pdb 2V1D.pdb                                                          #
    # Where sitemap-1.pdb, sitemap-2.pdb, sitemap-3.pdb, sitemap-4.pdb, sitemap-5.pdb are aligned to 2V1D.pdb  #
################################################################################################################
